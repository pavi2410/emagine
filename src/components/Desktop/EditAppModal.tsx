          ...
          <Dialog.Portal keepMounted>
            ...
            <div className="fixed inset-0 z-10000 flex items-center justify-center pointer-events-none">
              <Dialog.Popup
                ...
                className="pointer-events-auto w-[400px] max-h-[70vh] bg-[#2a2a2a]/80 backdrop-blur-3xl backdrop-saturate-200 rounded-xl shadow-[0_22px_70px_4px_rgba(0,0,0,0.56)] border border-white/15 overflow-hidden flex flex-col"
              >
              {/* Header - macOS style */}
