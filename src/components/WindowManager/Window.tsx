...
export function Window({ window: win, app }: WindowProps) {
  return (
    ...
    >
      <div className="h-full w-full flex flex-col bg-white dark:bg-slate-800 rounded-lg shadow-2xl border border-slate-700 overflow-hidden">
        {/* Title Bar */}
        <Flex
          justify="between"
          align="center"
          className="window-drag-handle px-4 py-2 bg-slate-100 dark:bg-slate-900 border-b border-slate-700 cursor-move shrink-0"
        >
